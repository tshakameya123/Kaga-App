  ...
  return (
    <div className='min-h-screen bg-white border-r'>
      {aToken && <ul className='text-[#515151] mt-5'>
        ...
        <NavLink to={'/admin-reports'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <span className='min-w-5 text-center'>📊</span>
          <p className='hidden md:block'>Reports & Analytics</p>
        </NavLink>
        <NavLink to={'/admin-notifications'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <span className='min-w-5 text-center'>🔔</span>
      ...
      {dToken && <ul className='text-[#515151] mt-5'>
        ...
        <NavLink to={'/doctor-schedule'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <span className='min-w-5 text-center'>📅</span>
          <p className='hidden md:block'>Schedule</p>
        </NavLink>
        <NavLink to={'/patient-history'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <span className='min-w-5 text-center'>📋</span>
          <p className='hidden md:block'>Patient History</p>
        </NavLink>
        <NavLink to={'/doctor-notifications'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <span className='min-w-5 text-center'>🔔</span>
          <p className='hidden md:block'>Notifications</p>
        </NavLink>
